...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(125),
  [70] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(91),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(133),
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(6),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(71),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(71),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(73),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(57),
  [91] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(74),
  [94] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(132),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(131),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fragment, 1),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(139),
  [107] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(85),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(130),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(8),
  [116] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(75),
  [119] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(75),
  [122] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(69),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(56),
  [128] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(66),
  [131] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(134),
  [134] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(135),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 2),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 2),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_element, 2),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script_element, 2),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_comment_directive, 3, .production_id = 1),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_comment_directive, 3, .production_id = 1),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_output_directive, 3),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_output_directive, 3),
  ...
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_directive, 3),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_directive, 3),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_erroneous_end_tag, 3),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_erroneous_end_tag, 3),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_tag, 3),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_self_closing_tag, 3),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 1),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 1),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template, 1),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template, 1),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_tag, 4),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_start_tag, 4),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_doctype, 4),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_doctype, 4),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_element, 2),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_element, 2),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_element, 3),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script_element, 3),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_element, 3),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_element, 3),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_comment_directive, 2),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_comment_directive, 2),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 3),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 3),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_templating_liquid_block, 3),
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_templating_liquid_block, 3),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_graphql_directive, 3),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_graphql_directive, 3),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_templating_liquid_comment, 3),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_templating_liquid_comment, 3),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_end_tag, 3),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_end_tag, 3),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_tag, 3),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_start_tag, 3),
  [225] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_template_code_repeat1, 2), SHIFT_REPEAT(51),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_template_code_repeat1, 2),
  [230] = {.entry = {.count = 1, .reusable = false}}, SHIFT(54),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_code, 1),
  [234] = {.entry = {.count = 1, .reusable = false}}, SHIFT(51),
  [236] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_template_code_repeat1, 2), SHIFT_REPEAT(54),
  ...
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_start_tag_repeat1, 2),
  [253] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_start_tag_repeat1, 2), SHIFT_REPEAT(68),
  ...
  [270] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_start_tag_repeat1, 2), SHIFT_REPEAT(81),
  ...
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 1),
  ...
  [291] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_template_code_repeat1, 2), SHIFT_REPEAT(72),
  ...
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 3),
  ...
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_start_tag, 4),
  [356] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_start_tag, 4),
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_start_tag, 3),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_start_tag, 3),
